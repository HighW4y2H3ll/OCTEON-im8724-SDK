...
/** Disable debug printfs in simple exec. */
#define CVMX_ENABLE_DEBUG_PRINTS		0

/** Mask of chip selects to probe for a NAND device */
#define NAND_PROBE_MASK		0x1e
 ...
 * valid address.
 */
#define STAGE2_LOAD_ADDR	0xFFFFFFFF8100c000ull
/**
 ...
 */
#define STAGE2_DRAM_SIZE	((512 - 48) * 1024)
...
/**
 * Size of heap in bytes, must be multiple of 16
 */
...
#define CONFIG_SPI_EEPROM_M95XXX
...
#define CONFIG_NAND_HEADER_SEARCH_END		0x8000

/**
 * How many bytes to scan in the NAND flash for a valid NAND bootloader
 */
#define CONFIG_NAND_SCAN_SIZE			(4*1024*1024)
/**
 * Minimum alignment required for DMA
 */
