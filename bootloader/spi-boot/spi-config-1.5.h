...
/** GPIO pin indicating we should load the failsafe bootloader */
#define CONFIG_FAILSAFE_GPIO	0
...
/** Starting offset to look for bootloaders */
#define CONFIG_HEADER_SEARCH_START		0x10000

/** How much to increment when searching for the bootloader header */
#define CONFIG_HEADER_SEARCH_INCREMENT		(4 * 1024)
 ...
 * valid address.
 */
#define STAGE2_LOAD_ADDR	0xFFFFFFFF81004000ull
 ...
 */
#define STAGE2_DRAM_SIZE	((512 - 16) * 1024)
