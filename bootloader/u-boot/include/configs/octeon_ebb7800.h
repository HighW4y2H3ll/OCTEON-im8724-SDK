...
/* Probe MCU to read the QLM mode */
//#define CONFIG_OCTEON_MCU_PROBE
...
#define CONFIG_SF_DEFAULT_CS	0	/** Default SPI CS		*/
#define CONFIG_SF_DEFAULT_SPEED	16000000	/** Default SPI bus speed */
...
#if 0
/** Enable this to store the environment in SPI NOR */
# define CONFIG_ENV_IS_IN_SPI_FLASH	1
#endif

/** Start address where the SPI stage 2 bootloader can be stored */
#define CONFIG_OCTEON_SPI_BOOT_START	0x10000

/** End offset for SPI bootloader support */
...
#define CONFIG_SYS_FLASH_USE_BUFFER_WRITE	/** Speed up NOR FLASH writes */

/* We're not RAM_RESIDENT so CONFIG_ENV_IS_IN_FLASH will be set. */

#ifdef CONFIG_ENV_IS_IN_SPI_FLASH
# define CONFIG_ENV_SECT_SIZE		256	/** SPI NOR sector size */
# define CONFIG_ENV_OFFSET		0xe000	/** SPI NOR environment offset */
...
# define CONFIG_ENV_SIZE		(8*1024)	/** NOR flash env size */
/** NOR flash environment address */
