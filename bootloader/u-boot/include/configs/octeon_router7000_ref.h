...
#define ROUTER7000_REF_DEF_DRAM_FREQ	533
...
/* SATA support */
#define CONFIG_SATA_AHCI		/** AHCI support */
#define CONFIG_SATA_PMP
#define CONFIG_SATA_AHCI_PLAT		/** Platform-specific AHCI	*/
#define CONFIG_SATA_AHCI_OCTEON		/** Octeon native SATA support	*/
