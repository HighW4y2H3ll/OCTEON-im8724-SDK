#ifndef __OCTEON_WAVE2_SHARED_H__
#define __OCTEON_WAVE2_SHARED_H__

#define WAVE2_MT41J256M16HA_125_32bits_1333_with_ecc_spd_CL9 \
...
#define WAVE2_MT41J256M16HA_125_32bits_1333_with_ecc_spd_CL10 \
0x92, 0x11, 0x0b, 0x02, 0x04, 0x19, 0x00, 0x02, 0x0a, 0x00, 0x01, 0x08, 0x0C, 0x00, 0x7c, 0x00 , \
...
#define WAVE2_DDR3_spd						\
	WAVE2_MT41J256M16HA_125_32bits_1333_with_ecc_spd_CL9

#define OCTEON_WAVE2_SPD_VALUES					\
	WAVE2_DDR3_spd

#define OCTEON_WAVE2_DRAM_SOCKET_CONFIGURATION0 \
    {{0x00, 0x00}, {octeon_wave2_spd_values, NULL}}

#define OCTEON_WAVE2_BOARD_EEPROM_TWSI_ADDR        (0x56)
 ...
 *
 */
#define OCTEON_WAVE2_MODEREG_PARAMS1_1RANK_1SLOT	\
{							\
	.cn63xx = {					\
		.pasr_00	= 0,			\
		.asr_00		= 0,			\
...
#define OCTEON_WAVE2_MODEREG_PARAMS1_2RANK_1SLOT	\
{							\
	.cn63xx = {					\
		.pasr_00	= 0,			\
		.asr_00		= 0,			\
...
#define OCTEON_WAVE2_DRAM_ODT_1RANK_CONFIGURATION \
	/* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1             reserved       RODT_CTL    RODT_MASK    reserved */	\
	/* =====   ======== ============== ==========================================  ============== ========= ============== ======== */	\
    /*   1 */ {   0,    0x00000001ULL, OCTEON_WAVE2_MODEREG_PARAMS1_1RANK_1SLOT, {.u64=0x0000},     3,     0x00000000ULL,  0  }      \

#define OCTEON_WAVE2_DRAM_ODT_2RANK_CONFIGURATION \
	/* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1             reserved       RODT_CTL    RODT_MASK    reserved */	\
	/* =====   ======== ============== ==========================================  ============== ========= ============== ======== */	\
    /*   1 */ {   0,    0x00000101ULL, OCTEON_WAVE2_MODEREG_PARAMS1_2RANK_1SLOT, {.u64=0x0000},     3,     0x00000000ULL,    0  }    \
...
#define OCTEON_WAVE2_DDR_CONFIGURATION {				\
	/* Interface 0 */						\
	.custom_lmc_config = {						\
		.min_rtt_nom_idx	= 1,				\
		.max_rtt_nom_idx	= 5,				\
        ...
        .dimm_config_table = {						\
            OCTEON_WAVE2_DRAM_SOCKET_CONFIGURATION0,		\
	...
	.odt_1rank_config = {                        			\
            OCTEON_WAVE2_DRAM_ODT_1RANK_CONFIGURATION,		\
	},								\
	.odt_2rank_config = {						\
            OCTEON_WAVE2_DRAM_ODT_2RANK_CONFIGURATION,		\
	},								\
}

#endif   /* __OCTEON_WAVE2_SHARED_H__ */
