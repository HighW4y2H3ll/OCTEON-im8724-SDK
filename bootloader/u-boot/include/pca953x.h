...
int pca953x_set_val(u8 bus, u8 chip, uint mask, uint data);
int pca953x_set_pol(u8 bus, u8 chip, uint mask, uint data);
int pca953x_set_dir(u8 bus, u8 chip, uint mask, uint data);
int pca953x_get_val(u8 bus, u8 chip);
