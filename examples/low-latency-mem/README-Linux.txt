...
Readme for the low-latency-mem example under Linux
...
the low-latency-mem-linux_64 executable has already been built and added
...
1) In the linux/kernel directory run the command:
  ./oct-linux -quiet -numcores=4 -llsize=655360
...
command:
   ./examples/low-latency-mem-linux_64
