...
enum opt_code
{
  ...
  OPT_mad = 995,                             /* -mad */
  OPT_mandroid = 996,                        /* -mandroid */
  OPT_march_ = 997,                          /* -march= */
  OPT_mbionic = 998,                         /* -mbionic */
  OPT_mbranch_cost_ = 999,                   /* -mbranch-cost= */
  OPT_mbranch_likely = 1000,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1001,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1002,                /* -mcode-readable= */
  OPT_mdebug = 1003,                         /* -mdebug */
  OPT_mdebugd = 1004,                        /* -mdebugd */
  OPT_mdivide_breaks = 1005,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1006,                  /* -mdivide-traps */
  OPT_mdmx = 1007,                           /* -mdmx */
  OPT_mdouble_float = 1008,                  /* -mdouble-float */
  OPT_mdsp = 1009,                           /* -mdsp */
  OPT_mdspr2 = 1010,                         /* -mdspr2 */
  OPT_meb = 1011,                            /* -meb */
  OPT_mel = 1012,                            /* -mel */
  OPT_membedded_data = 1013,                 /* -membedded-data */
  OPT_mexplicit_relocs = 1014,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1015,                  /* -mextern-sdata */
  OPT_mfix_24k = 1016,                       /* -mfix-24k */
  OPT_mfix_cn63xxp1 = 1017,                  /* -mfix-cn63xxp1 */
  OPT_mfix_r10000 = 1018,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1019,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1020,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1021,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1022,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1023,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1024,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1025,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1026,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1027,                 /* -mfp-exceptions */
  OPT_mfp32 = 1028,                          /* -mfp32 */
  OPT_mfp64 = 1029,                          /* -mfp64 */
  OPT_mfused_madd = 1030,                    /* -mfused-madd */
  OPT_mglibc = 1031,                         /* -mglibc */
  OPT_mgp32 = 1032,                          /* -mgp32 */
  OPT_mgp64 = 1033,                          /* -mgp64 */
  OPT_mgpopt = 1034,                         /* -mgpopt */
  OPT_mhard_float = 1035,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1036,              /* -minterlink-mips16 */
  OPT_mips = 1037,                           /* -mips */
  OPT_mips16 = 1038,                         /* -mips16 */
  OPT_mips3d = 1039,                         /* -mips3d */
  OPT_mllsc = 1040,                          /* -mllsc */
  OPT_mlocal_sdata = 1041,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1042,                    /* -mlong-calls */
  OPT_mlong32 = 1043,                        /* -mlong32 */
  OPT_mlong64 = 1044,                        /* -mlong64 */
  OPT_mmadd = 1045,                          /* -mmadd */
  ...
  OPT_mocteon_useun = 1054,                  /* -mocteon-useun */
  OPT_mpaired_single = 1055,                 /* -mpaired-single */
  OPT_mplt = 1056,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1057,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1058,               /* -mrelax-pic-calls */
  OPT_mshared = 1059,                        /* -mshared */
  OPT_mshared_variables = 1060,              /* -mshared-variables */
  OPT_msingle_float = 1061,                  /* -msingle-float */
  OPT_msmartmips = 1062,                     /* -msmartmips */
  OPT_msoft_float = 1063,                    /* -msoft-float */
  OPT_msplit_addresses = 1064,               /* -msplit-addresses */
  OPT_msym32 = 1065,                         /* -msym32 */
  OPT_msynci = 1066,                         /* -msynci */
  OPT_mtls_accel = 1067,                     /* -mtls-accel */
  OPT_mtune_ = 1068,                         /* -mtune= */
  OPT_muclibc = 1069,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1070,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1071,                  /* -mvr4130-align */
  OPT_mxgot = 1072,                          /* -mxgot */
  OPT_n = 1073,                              /* -n */
  OPT_no_canonical_prefixes = 1074,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1075,              /* -no-integrated-cpp */
  OPT_noasmopt = 1076,                       /* -noasmopt */
  OPT_nocpp = 1077,                          /* -nocpp */
  OPT_nodefaultlibs = 1078,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1079,                   /* -nostartfiles */
  OPT_nostdinc = 1080,                       /* -nostdinc */
  OPT_nostdinc__ = 1081,                     /* -nostdinc++ */
  OPT_nostdlib = 1082,                       /* -nostdlib */
  OPT_o = 1083,                              /* -o */
  OPT_p = 1084,                              /* -p */
  OPT_pass_exit_codes = 1085,                /* -pass-exit-codes */
  OPT_pedantic = 1086,                       /* -pedantic */
  OPT_pedantic_errors = 1087,                /* -pedantic-errors */
  OPT_pg = 1088,                             /* -pg */
  OPT_pie = 1089,                            /* -pie */
  OPT_pipe = 1090,                           /* -pipe */
  OPT_posix = 1091,                          /* -posix */
  ...
  OPT_print_objc_runtime_info = 1097,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1098,               /* -print-prog-name= */
  OPT_print_search_dirs = 1099,              /* -print-search-dirs */
  OPT_print_sysroot = 1100,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1101,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1102,                        /* -profile */
  OPT_pthread = 1103,                        /* -pthread */
  OPT_quiet = 1104,                          /* -quiet */
  OPT_r = 1105,                              /* -r */
  OPT_rdynamic = 1106,                       /* -rdynamic */
  ...
  OPT_time = 1158,                           /* -time */
  OPT_time_ = 1159,                          /* -time= */
  OPT_tno_android_cc = 1160,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1161,                 /* -tno-android-ld */
