...
#endif
#ifdef GENERATOR_FILE
extern int flag_merge_const_bfstores;
#else
  int x_flag_merge_const_bfstores;
#define flag_merge_const_bfstores global_options.x_flag_merge_const_bfstores
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_postreload_load;
#else
  int x_flag_postreload_load;
#define flag_postreload_load global_options.x_flag_postreload_load
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_propagate_block_prob;
#else
  int x_flag_propagate_block_prob;
#define flag_propagate_block_prob global_options.x_flag_propagate_block_prob
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_MADD;
#else
  int x_TARGET_MADD;
#define TARGET_MADD global_options.x_TARGET_MADD
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_SHARED_VARIABLES;
#else
  int x_TARGET_SHARED_VARIABLES;
#define TARGET_SHARED_VARIABLES global_options.x_TARGET_SHARED_VARIABLES
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mfix_cn63xxp1;
#define x_VAR_mfix_cn63xxp1 do_not_use
#endif
#ifndef GENERATOR_FILE
...
#define MASK_OCTEON_UNALIGNED (1 << 20)
...
#define TARGET_TLS_ACCEL ((target_flags & MASK_TLS_ACCEL) != 0)
...
enum opt_code
{
  ...
  OPT_fmerge_const_bfstores = 686,           /* -fmerge-const-bfstores */
  ...
  OPT_fpostreload_load = 740,                /* -fpostreload-load */
  ...
  OPT_fprofile_gen_atomic_ = 750,            /* -fprofile-gen-atomic= */
  ...
  OPT_fpropagate_block_prob = 756,           /* -fpropagate-block-prob */
  OPT_fprotect_parens = 757,                 /* -fprotect-parens */
  OPT_frandom_seed = 758,                    /* -frandom-seed */
  OPT_frandom_seed_ = 759,                   /* -frandom-seed= */
  OPT_frange_check = 760,                    /* -frange-check */
  OPT_freal_4_real_10 = 761,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 762,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 763,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 764,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 765,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 766,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 767,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 768,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 769,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 770,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 771,                /* -frecord-marker=8 */
  OPT_frecursive = 772,                      /* -frecursive */
  OPT_freduced_reflection = 773,             /* -freduced-reflection */
  OPT_free = 774,                            /* -free */
  OPT_freg_struct_return = 775,              /* -freg-struct-return */
  OPT_fregmove = 776,                        /* -fregmove */
  OPT_frename_registers = 777,               /* -frename-registers */
  OPT_freorder_blocks = 778,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 779,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 780,              /* -freorder-functions */
  OPT_frepack_arrays = 781,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 782,           /* -freplace-objc-classes */
  OPT_frepo = 783,                           /* -frepo */
  OPT_frequire_return_statement = 784,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 785,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 786, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 787,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 788,                    /* -fresolution= */
  OPT_frounding_math = 789,                  /* -frounding-math */
  OPT_frtti = 790,                           /* -frtti */
  OPT_fsanitize_ = 791,                      /* -fsanitize= */
  ...
  OPT_fsched_pressure_algorithm_ = 799,      /* -fsched-pressure-algorithm= */
  ...
  OPT_fshrink_wrap = 826,                    /* -fshrink-wrap */
  OPT_fsign_zero = 827,                      /* -fsign-zero */
  OPT_fsignaling_nans = 828,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 829,               /* -fsigned-bitfields */
  OPT_fsigned_char = 830,                    /* -fsigned-char */
  OPT_fsigned_zeros = 831,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 832,      /* -fsingle-precision-constant */
  ...
  OPT_fstack_arrays = 839,                   /* -fstack-arrays */
  /* OPT_fstack_check = 840, */              /* -fstack-check */
  OPT_fstack_check_ = 841,                   /* -fstack-check= */
  OPT_fstack_limit = 842,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 843,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 844,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 845,                /* -fstack-protector */
  OPT_fstack_protector_all = 846,            /* -fstack-protector-all */
  ...
  OPT_fsync_libcalls = 856,                  /* -fsync-libcalls */
  ...
  OPT_ftrack_macro_expansion = 871,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 872,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 873,                  /* -ftrapping-math */
  OPT_ftrapv = 874,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 875,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 876,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 877,                       /* -ftree-ccp */
  OPT_ftree_ch = 878,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 879,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 880,             /* -ftree-coalesce-vars */
  ...
  OPT_ftree_loop_distribute_patterns = 889,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 890,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 891,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 892,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 893,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 894,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 895, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 896,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 897,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 898,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 899,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 900,                   /* -ftree-phiprop */
  OPT_ftree_pre = 901,                       /* -ftree-pre */
  OPT_ftree_pta = 902,                       /* -ftree-pta */
  OPT_ftree_reassoc = 903,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 904, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 905,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 906,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 907,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 908,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 909, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 910, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 911,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 912,                /* -ftree-tail-merge */
  OPT_ftree_ter = 913,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 914,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 915,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 916,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 917,                       /* -ftree-vrp */
  OPT_funderscoring = 918,                   /* -funderscoring */
  OPT_funit_at_a_time = 919,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 920,               /* -funroll-all-loops */
  OPT_funroll_loops = 921,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 922,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 923,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 924,             /* -funsigned-bitfields */
  OPT_funsigned_char = 925,                  /* -funsigned-char */
  OPT_funswitch_loops = 926,                 /* -funswitch-loops */
  OPT_funwind_tables = 927,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 928,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 929,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 930,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 931,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 932,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 933,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 934,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 935,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 936,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 937,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 938, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 939,                /* -fvect-cost-model */
  OPT_fverbose_asm = 940,                    /* -fverbose-asm */
  /* OPT_fversion = 941, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 942,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 943,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 944,                    /* -fvisibility= */
  OPT_fvpt = 945,                            /* -fvpt */
  /* OPT_fvtable_gc = 946, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 947, */            /* -fvtable-thunks */
  OPT_fweak = 948,                           /* -fweak */
  OPT_fweb = 949,                            /* -fweb */
  OPT_fwhole_file = 950,                     /* -fwhole-file */
  OPT_fwhole_program = 951,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 952,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 953,              /* -fworking-directory */
  OPT_fwpa = 954,                            /* -fwpa */
  OPT_fwrapv = 955,                          /* -fwrapv */
  /* OPT_fxref = 956, */                     /* -fxref */
  /* OPT_fzee = 957, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 958,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 959,                      /* -fzero-link */
  OPT_g = 960,                               /* -g */
  OPT_gant = 961,                            /* -gant */
  OPT_gcoff = 962,                           /* -gcoff */
  OPT_gdwarf_ = 963,                         /* -gdwarf- */
  OPT_gen_decls = 964,                       /* -gen-decls */
  OPT_ggdb = 965,                            /* -ggdb */
  OPT_gnat = 966,                            /* -gnat */
  OPT_gnatO = 967,                           /* -gnatO */
  OPT_gno_record_gcc_switches = 968,         /* -gno-record-gcc-switches */
  OPT_gno_strict_dwarf = 969,                /* -gno-strict-dwarf */
  OPT_grecord_gcc_switches = 970,            /* -grecord-gcc-switches */
  OPT_gstabs = 971,                          /* -gstabs */
  OPT_gstabs_ = 972,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 973,                   /* -gstrict-dwarf */
  OPT_gtoggle = 974,                         /* -gtoggle */
  OPT_gvms = 975,                            /* -gvms */
  OPT_gxcoff = 976,                          /* -gxcoff */
  OPT_gxcoff_ = 977,                         /* -gxcoff+ */
  OPT_h = 978,                               /* -h */
  OPT_idirafter = 979,                       /* -idirafter */
  OPT_imacros = 980,                         /* -imacros */
  OPT_imultilib = 981,                       /* -imultilib */
  OPT_include = 982,                         /* -include */
  OPT_iplugindir_ = 983,                     /* -iplugindir= */
  OPT_iprefix = 984,                         /* -iprefix */
  OPT_iquote = 985,                          /* -iquote */
  OPT_isysroot = 986,                        /* -isysroot */
  OPT_isystem = 987,                         /* -isystem */
  OPT_iwithprefix = 988,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 989,               /* -iwithprefixbefore */
  OPT_k8 = 990,                              /* -k8 */
  OPT_l = 991,                               /* -l */
  OPT_lang_asm = 992,                        /* -lang-asm */
  OPT_mabi_ = 993,                           /* -mabi= */
  OPT_mabicalls = 994,                       /* -mabicalls */
  OPT_mad = 995,                             /* -mad */
  OPT_march_ = 996,                          /* -march= */
  OPT_mbranch_cost_ = 997,                   /* -mbranch-cost= */
  OPT_mbranch_likely = 998,                  /* -mbranch-likely */
  OPT_mcheck_zero_division = 999,            /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1000,                /* -mcode-readable= */
  OPT_mdebug = 1001,                         /* -mdebug */
  OPT_mdebugd = 1002,                        /* -mdebugd */
  OPT_mdivide_breaks = 1003,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1004,                  /* -mdivide-traps */
  OPT_mdmx = 1005,                           /* -mdmx */
  OPT_mdouble_float = 1006,                  /* -mdouble-float */
  OPT_mdsp = 1007,                           /* -mdsp */
  OPT_mdspr2 = 1008,                         /* -mdspr2 */
  OPT_meb = 1009,                            /* -meb */
  OPT_mel = 1010,                            /* -mel */
  OPT_membedded_data = 1011,                 /* -membedded-data */
  OPT_mexplicit_relocs = 1012,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1013,                  /* -mextern-sdata */
  OPT_mfix_24k = 1014,                       /* -mfix-24k */
  OPT_mfix_cn63xxp1 = 1015,                  /* -mfix-cn63xxp1 */
  OPT_mfix_r10000 = 1016,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1017,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1018,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1019,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1020,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1021,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1022,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1023,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1024,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1025,                 /* -mfp-exceptions */
  OPT_mfp32 = 1026,                          /* -mfp32 */
  OPT_mfp64 = 1027,                          /* -mfp64 */
  OPT_mfused_madd = 1028,                    /* -mfused-madd */
  OPT_mgp32 = 1029,                          /* -mgp32 */
  OPT_mgp64 = 1030,                          /* -mgp64 */
  OPT_mgpopt = 1031,                         /* -mgpopt */
  OPT_mhard_float = 1032,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1033,              /* -minterlink-mips16 */
  OPT_mips = 1034,                           /* -mips */
  OPT_mips16 = 1035,                         /* -mips16 */
  OPT_mips3d = 1036,                         /* -mips3d */
  OPT_mllsc = 1037,                          /* -mllsc */
  OPT_mlocal_sdata = 1038,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1039,                    /* -mlong-calls */
  OPT_mlong32 = 1040,                        /* -mlong32 */
  OPT_mlong64 = 1041,                        /* -mlong64 */
  OPT_mmadd = 1042,                          /* -mmadd */
  OPT_mmcount_ra_address = 1043,             /* -mmcount-ra-address */
  OPT_mmemcpy = 1044,                        /* -mmemcpy */
  OPT_mmt = 1045,                            /* -mmt */
  OPT_mno_float = 1046,                      /* -mno-float */
  OPT_mno_flush_func = 1047,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1048,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1049,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1050,                     /* -mno-mips3d */
  OPT_mocteon_useun = 1051,                  /* -mocteon-useun */
  OPT_mpaired_single = 1052,                 /* -mpaired-single */
  OPT_mplt = 1053,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1054,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1055,               /* -mrelax-pic-calls */
  OPT_mshared = 1056,                        /* -mshared */
  OPT_mshared_variables = 1057,              /* -mshared-variables */
  OPT_msingle_float = 1058,                  /* -msingle-float */
  OPT_msmartmips = 1059,                     /* -msmartmips */
  OPT_msoft_float = 1060,                    /* -msoft-float */
  OPT_msplit_addresses = 1061,               /* -msplit-addresses */
  OPT_msym32 = 1062,                         /* -msym32 */
  OPT_msynci = 1063,                         /* -msynci */
  OPT_mtls_accel = 1064,                     /* -mtls-accel */
  OPT_mtune_ = 1065,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1066,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1067,                  /* -mvr4130-align */
  OPT_mxgot = 1068,                          /* -mxgot */
  OPT_n = 1069,                              /* -n */
  OPT_no_canonical_prefixes = 1070,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1071,              /* -no-integrated-cpp */
  OPT_noasmopt = 1072,                       /* -noasmopt */
  OPT_nocpp = 1073,                          /* -nocpp */
  OPT_nodefaultlibs = 1074,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1075,                   /* -nostartfiles */
  OPT_nostdinc = 1076,                       /* -nostdinc */
  OPT_nostdinc__ = 1077,                     /* -nostdinc++ */
  OPT_nostdlib = 1078,                       /* -nostdlib */
  OPT_o = 1079,                              /* -o */
  OPT_p = 1080,                              /* -p */
  OPT_pass_exit_codes = 1081,                /* -pass-exit-codes */
  OPT_pedantic = 1082,                       /* -pedantic */
  OPT_pedantic_errors = 1083,                /* -pedantic-errors */
  OPT_pg = 1084,                             /* -pg */
  OPT_pie = 1085,                            /* -pie */
  OPT_pipe = 1086,                           /* -pipe */
  OPT_print_file_name_ = 1087,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1088,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1089,          /* -print-multi-directory */
  OPT_print_multi_lib = 1090,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1091,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1092,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1093,               /* -print-prog-name= */
  OPT_print_search_dirs = 1094,              /* -print-search-dirs */
  OPT_print_sysroot = 1095,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1096,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1097,                          /* -quiet */
  OPT_r = 1098,                              /* -r */
  OPT_remap = 1099,                          /* -remap */
  OPT_s = 1100,                              /* -s */
  OPT_s_bc_abi = 1101,                       /* -s-bc-abi */
  OPT_save_temps = 1102,                     /* -save-temps */
  OPT_save_temps_ = 1103,                    /* -save-temps= */
  OPT_shared = 1104,                         /* -shared */
  OPT_shared_libgcc = 1105,                  /* -shared-libgcc */
  /* OPT_specs = 1106, */                    /* -specs */
  OPT_specs_ = 1107,                         /* -specs= */
  OPT_static = 1108,                         /* -static */
  OPT_static_libasan = 1109,                 /* -static-libasan */
  ...
  OPT_static_libtsan = 1115,                 /* -static-libtsan */
  OPT_static_libubsan = 1116,                /* -static-libubsan */
  /* OPT_std_c__03 = 1117, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1118, */                /* -std=c++0x */
  OPT_std_c__11 = 1119,                      /* -std=c++11 */
  OPT_std_c__98 = 1120,                      /* -std=c++98 */
  OPT_std_c11 = 1121,                        /* -std=c11 */
  /* OPT_std_c1x = 1122, */                  /* -std=c1x */
  /* OPT_std_c89 = 1123, */                  /* -std=c89 */
  OPT_std_c90 = 1124,                        /* -std=c90 */
  OPT_std_c99 = 1125,                        /* -std=c99 */
  /* OPT_std_c9x = 1126, */                  /* -std=c9x */
  OPT_std_f2003 = 1127,                      /* -std=f2003 */
  OPT_std_f2008 = 1128,                      /* -std=f2008 */
  OPT_std_f2008ts = 1129,                    /* -std=f2008ts */
  OPT_std_f95 = 1130,                        /* -std=f95 */
  OPT_std_gnu = 1131,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1132, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1133, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1134,                    /* -std=gnu++11 */
  OPT_std_gnu__98 = 1135,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1136,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1137, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1138, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1139,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1140,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1141, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1142, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1143,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1144, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1145, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1146, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1147,                     /* -std=legacy */
  OPT_symbolic = 1148,                       /* -symbolic */
  OPT_t = 1149,                              /* -t */
  OPT_time = 1150,                           /* -time */
  OPT_time_ = 1151,                          /* -time= */
