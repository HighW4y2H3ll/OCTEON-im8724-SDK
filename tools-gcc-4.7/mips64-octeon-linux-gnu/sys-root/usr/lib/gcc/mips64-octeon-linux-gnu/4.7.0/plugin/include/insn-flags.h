...
#define HAVE_smulsi3_highpart_internal (!ISA_HAS_DMUL3 && !ISA_HAS_MULHI && !TARGET_MIPS16)
#define HAVE_umulsi3_highpart_internal (!ISA_HAS_DMUL3 && !ISA_HAS_MULHI && !TARGET_MIPS16)
...
#define HAVE_bswapdi2 (TARGET_64BIT && ISA_HAS_SBWH)
#define HAVE_bswapsi2 (ISA_HAS_SBWH)
#define HAVE_bswaphi2 (ISA_HAS_SBWH)
...
#define HAVE_mov_lwl (!TARGET_MIPS16 && mips_mem_fits_mode_p (SImode, operands[1]) && !ISA_HAS_UL_US)
#define HAVE_mov_ldl ((!TARGET_MIPS16 && mips_mem_fits_mode_p (DImode, operands[1]) && !ISA_HAS_UL_US) && (TARGET_64BIT))
#define HAVE_mov_lwr (!TARGET_MIPS16 && mips_mem_fits_mode_p (SImode, operands[1]) && !ISA_HAS_UL_US)
#define HAVE_mov_ldr ((!TARGET_MIPS16 && mips_mem_fits_mode_p (DImode, operands[1]) && !ISA_HAS_UL_US) && (TARGET_64BIT))
#define HAVE_mov_swl (!TARGET_MIPS16 && mips_mem_fits_mode_p (SImode, operands[0]) && !ISA_HAS_UL_US)
#define HAVE_mov_sdl ((!TARGET_MIPS16 && mips_mem_fits_mode_p (DImode, operands[0]) && !ISA_HAS_UL_US) && (TARGET_64BIT))
#define HAVE_mov_swr (!TARGET_MIPS16 && mips_mem_fits_mode_p (SImode, operands[0]) && !ISA_HAS_UL_US)
#define HAVE_mov_sdr ((!TARGET_MIPS16 && mips_mem_fits_mode_p (DImode, operands[0]) && !ISA_HAS_UL_US) && (TARGET_64BIT))
...
#define HAVE_memory_barrier_w_internal (TARGET_OCTEON)
...
#define HAVE_atomic_exchangesi_llsc (GENERATE_LL_SC && !ISA_HAS_SWAP && !ISA_HAS_LAW)
#define HAVE_atomic_exchangedi_llsc ((GENERATE_LL_SC && !ISA_HAS_SWAP && !ISA_HAS_LAW) && (TARGET_64BIT))
#define HAVE_atomic_exchangesi_law (ISA_HAS_LAW)
#define HAVE_atomic_exchangedi_law ((ISA_HAS_LAW) && (TARGET_64BIT))
#define HAVE_atomic_addsi_llsc (GENERATE_LL_SC && !ISA_HAS_SAA)
#define HAVE_atomic_adddi_llsc ((GENERATE_LL_SC && !ISA_HAS_SAA) && (TARGET_64BIT))
#define HAVE_atomic_addsi_saa (ISA_HAS_SAA)
#define HAVE_atomic_adddi_saa ((ISA_HAS_SAA) && (TARGET_64BIT))
#define HAVE_atomic_subsi_llsc (GENERATE_LL_SC && !ISA_HAS_SAA)
#define HAVE_atomic_subdi_llsc ((GENERATE_LL_SC && !ISA_HAS_SAA) && (TARGET_64BIT))
#define HAVE_atomic_fetch_subsi_llsc (GENERATE_LL_SC && !ISA_HAS_LDADD && !ISA_HAS_LAA)
#define HAVE_atomic_fetch_subdi_llsc ((GENERATE_LL_SC && !ISA_HAS_LDADD && !ISA_HAS_LAA) && (TARGET_64BIT))
#define HAVE_atomic_fetch_addsi_llsc (GENERATE_LL_SC && !ISA_HAS_LDADD && !ISA_HAS_LAA)
#define HAVE_atomic_fetch_adddi_llsc ((GENERATE_LL_SC && !ISA_HAS_LDADD && !ISA_HAS_LAA) && (TARGET_64BIT))
#define HAVE_atomic_fetch_addsi_laa (ISA_HAS_LAA)
#define HAVE_atomic_fetch_adddi_laa ((ISA_HAS_LAA) && (TARGET_64BIT))
#define HAVE_atomic_fetch_iorsi (GENERATE_LL_SC)
#define HAVE_atomic_fetch_xorsi (GENERATE_LL_SC)
#define HAVE_atomic_fetch_andsi (GENERATE_LL_SC)
#define HAVE_atomic_fetch_iordi ((GENERATE_LL_SC) && (TARGET_64BIT))
#define HAVE_atomic_fetch_xordi ((GENERATE_LL_SC) && (TARGET_64BIT))
#define HAVE_atomic_fetch_anddi ((GENERATE_LL_SC) && (TARGET_64BIT))
#define HAVE_atomic_iorsi (GENERATE_LL_SC)
#define HAVE_atomic_xorsi (GENERATE_LL_SC)
#define HAVE_atomic_andsi (GENERATE_LL_SC)
#define HAVE_atomic_iordi ((GENERATE_LL_SC) && (TARGET_64BIT))
#define HAVE_atomic_xordi ((GENERATE_LL_SC) && (TARGET_64BIT))
#define HAVE_atomic_anddi ((GENERATE_LL_SC) && (TARGET_64BIT))
...
#define HAVE_smulsi3_highpart (!ISA_HAS_DMUL3)
#define HAVE_umulsi3_highpart (!ISA_HAS_DMUL3)
...
#define HAVE_movmisaligndi (TARGET_64BIT)
#define HAVE_movsi 1
...
#define HAVE_cstoresf4 ((ISA_HAS_CONDMOVE) && (TARGET_HARD_FLOAT))
#define HAVE_cstoredf4 ((ISA_HAS_CONDMOVE) && (TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT))
#define HAVE_jump 1
...
#define HAVE_memory_barrier_w (TARGET_OCTEON)
#define HAVE_memory_barrier_r (TARGET_OCTEON)
...
#define HAVE_atomic_exchangesi (GENERATE_LL_SC || ISA_HAS_SWAP || ISA_HAS_LAW)
#define HAVE_atomic_exchangedi ((GENERATE_LL_SC || ISA_HAS_SWAP || ISA_HAS_LAW) && (TARGET_64BIT))
#define HAVE_atomic_fetch_addsi (GENERATE_LL_SC || ISA_HAS_LDADD || ISA_HAS_LAA)
#define HAVE_atomic_fetch_adddi ((GENERATE_LL_SC || ISA_HAS_LDADD || ISA_HAS_LAA) && (TARGET_64BIT))
#define HAVE_atomic_fetch_subsi (GENERATE_LL_SC || ISA_HAS_LDADD || ISA_HAS_LAA)
#define HAVE_atomic_fetch_subdi ((GENERATE_LL_SC || ISA_HAS_LDADD || ISA_HAS_LAA) && (TARGET_64BIT))
#define HAVE_atomic_addsi (GENERATE_LL_SC || ISA_HAS_SAA)
#define HAVE_atomic_adddi ((GENERATE_LL_SC || ISA_HAS_SAA) && (TARGET_64BIT))
#define HAVE_atomic_subsi (GENERATE_LL_SC || ISA_HAS_SAA)
#define HAVE_atomic_subdi ((GENERATE_LL_SC || ISA_HAS_SAA) && (TARGET_64BIT))
#define HAVE_atomic_add_fetchsi (GENERATE_LL_SC || ISA_HAS_LDADD || ISA_HAS_LAA)
#define HAVE_atomic_add_fetchdi ((GENERATE_LL_SC || ISA_HAS_LDADD || ISA_HAS_LAA) && (TARGET_64BIT))
#define HAVE_atomic_sub_fetchsi (GENERATE_LL_SC || ISA_HAS_LDADD || ISA_HAS_LAA)
#define HAVE_atomic_sub_fetchdi ((GENERATE_LL_SC || ISA_HAS_LDADD || ISA_HAS_LAA) && (TARGET_64BIT))
...
#define HAVE_atomic_ior_fetchsi (GENERATE_LL_SC)
#define HAVE_atomic_xor_fetchsi (GENERATE_LL_SC)
#define HAVE_atomic_and_fetchsi (GENERATE_LL_SC)
#define HAVE_atomic_ior_fetchdi ((GENERATE_LL_SC) && (TARGET_64BIT))
#define HAVE_atomic_xor_fetchdi ((GENERATE_LL_SC) && (TARGET_64BIT))
#define HAVE_atomic_and_fetchdi ((GENERATE_LL_SC) && (TARGET_64BIT))
...
extern rtx        gen_memory_barrier_w_internal       (rtx);
...
static inline rtx gen_atomic_exchangesi_swap          (rtx, rtx, rtx);
static inline rtx
gen_atomic_exchangesi_swap(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_atomic_exchangedi_swap          (rtx, rtx, rtx);
static inline rtx
gen_atomic_exchangedi_swap(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_atomic_exchangesi_law           (rtx, rtx, rtx, rtx);
extern rtx        gen_atomic_exchangedi_law           (rtx, rtx, rtx, rtx);
extern rtx        gen_atomic_addsi_llsc               (rtx, rtx, rtx);
extern rtx        gen_atomic_adddi_llsc               (rtx, rtx, rtx);
extern rtx        gen_atomic_addsi_saa                (rtx, rtx, rtx);
extern rtx        gen_atomic_adddi_saa                (rtx, rtx, rtx);
extern rtx        gen_atomic_subsi_llsc               (rtx, rtx, rtx);
extern rtx        gen_atomic_subdi_llsc               (rtx, rtx, rtx);
extern rtx        gen_atomic_fetch_subsi_llsc         (rtx, rtx, rtx, rtx);
extern rtx        gen_atomic_fetch_subdi_llsc         (rtx, rtx, rtx, rtx);
extern rtx        gen_atomic_fetch_addsi_llsc         (rtx, rtx, rtx, rtx);
extern rtx        gen_atomic_fetch_adddi_llsc         (rtx, rtx, rtx, rtx);
static inline rtx gen_atomic_fetch_addsi_ldadd        (rtx, rtx, rtx);
static inline rtx
gen_atomic_fetch_addsi_ldadd(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_atomic_fetch_adddi_ldadd        (rtx, rtx, rtx);
static inline rtx
gen_atomic_fetch_adddi_ldadd(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_atomic_fetch_addsi_laa          (rtx, rtx, rtx, rtx);
extern rtx        gen_atomic_fetch_adddi_laa          (rtx, rtx, rtx, rtx);
...
extern rtx        gen_memory_barrier_w                (void);
extern rtx        gen_memory_barrier_r                (void);
