/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/usr/local/Cavium_Networks/octsw/toolchain/scripts/../src/gcc/config/mips/mips.md'.  */
...
extern int bitmask_operand (rtx, enum machine_mode);
extern int bottom_bitmask_operand (rtx, enum machine_mode);
extern int inverse_bitmask_operand (rtx, enum machine_mode);
extern int and_reg_without_bitmask_operand (rtx, enum machine_mode);
...
extern int uns_arith_or_bitmask_operand (rtx, enum machine_mode);
...
extern int mips_cstorefp_operator (rtx, enum machine_mode);
extern int small_data_pattern (rtx, enum machine_mode);
extern int lai_operand (rtx, enum machine_mode);
extern int lad_operand (rtx, enum machine_mode);
extern int laa_lai_lad_operand (rtx, enum machine_mode);
extern int law_lac_las_operand (rtx, enum machine_mode);
